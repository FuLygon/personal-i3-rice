class DateTime {
	...
	_setTime() {
		...
		this._greeterDate.innerText = `${this._daysArr[date.getDay()]}, ${this._appendZero(date.getDate())} ` +
			`${this._monthsArr[date.getMonth()]}, ${date.getFullYear()}`;
		this._sidebarDate.innerText = `${this._getDayOrdinal(this._appendZero(date.getDate()))} of ` +
